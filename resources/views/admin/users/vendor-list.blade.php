                ...
                <form action="" method="GET">
                    <div class="card-header">
                        <div class="card-title">
                            <button type="button" onclick ="window.location.href='{{route("users.vendor_index")}}'" class="btn btn-default btn-sm">reset</button>
                        </div>
                            ...
                            @foreach ($users as $user)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="#" onclick="destroyUser({{$user->id}})" class="text-danger w-4 h-4 mr-1">
